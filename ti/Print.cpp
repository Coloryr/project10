...
size_t Print1::printf(const char *format, ...)
{
    char loc_buf[64];
    char * temp = loc_buf;
    va_list arg;
...
size_t Print1::print(const String1 &s)
{
...
size_t Print1::print(float n, int digits)
{
    return printFloat(n, digits);
}

size_t Print1::print(const Printable& x)
{
...
size_t Print1::println(const String1 &s)
{
    size_t n = print(s);
    n += println();
    return n;
...
size_t Print1::println(float num, int digits)
{
...
size_t Print1::println(const Printable& x)
{
    size_t n = print(x);
    n += println();
    return n;
...
size_t Print1::printFloat(float number, uint8_t digits)
{
    size_t n = 0;
